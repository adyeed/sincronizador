...
public class SituacionRegistral implements Serializable {
    ...
    private LinkedList<Respuestas> respuestases = new LinkedList<Respuestas>();
     ...
     */
    public void setEstatuSituacionRegistral(
        EstatusSituacionRegistral estatuSituacionRegistral) {
     ...
     */
    public void setRespuestases(LinkedList<Respuestas> respuestases) {
