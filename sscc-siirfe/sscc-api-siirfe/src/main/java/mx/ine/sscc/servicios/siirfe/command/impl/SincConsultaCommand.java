 ...
 */
@Component
public class SincConsultaCommand implements Command {
    /**
     ...
     */
    @Resource
    @Qualifier("SincronizadorConsultaExter")
    public Sincronizador sincronizadorConsultaExter;

    /**
     * TODO [Constructor]
     * @author Orlando Adrián Ramos Galván,(orlandoa.ramos@outlook.com)
     */
    public SincConsultaCommand() {
    ...
    public Callable<?> execute() {
        // TODO [codificar el cuerpo del método]
        return (Callable<?>) sincronizadorConsultaExter;
    }
