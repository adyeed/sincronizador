 ...
 */
@Component
public class AnalisisRegObservador implements Observer {

    private static final Logger logger = LoggerFactory.getLogger(AnalisisRegObservador.class);
    ...
    @Resource
    @Qualifier("InvocadorAnalisisRegImpl")
    private Invocador invocadorAnalisisRegImpl;
    ...
    public void update(Observable observable, Object arg1) {
        ...
        try {
             ...
             * Invocador.
             */
            executorService.submit(invocadorAnalisisRegImpl.initSinc());
        } catch (Exception e) {
