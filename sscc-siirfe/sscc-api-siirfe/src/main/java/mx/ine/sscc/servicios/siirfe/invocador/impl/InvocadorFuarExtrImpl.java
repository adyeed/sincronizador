...
import mx.ine.sscc.servicios.siirfe.command.impl.SincFuarExtrCommand;
 ...
 * @since SIIRFE 5.10
 */
@Service("InvocadorFuarExtrImpl")
public class InvocadorFuarExtrImpl implements Invocador {
     ...
     * TODO [Constructor]
     * @author Orlando Adrián Ramos Galván,(orlandoa.ramos@outlook.com)
     * @param initSincFuarExtrCommand
     */
    @Autowired
    public InvocadorFuarExtrImpl(SincFuarExtrCommand initSincFuarExtrCommand) {
        // TODO [codificar el cuerpo del método]
        this.initSincCommand = initSincFuarExtrCommand;
    }
