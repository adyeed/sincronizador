 ...
 */
@Component
public class SincFuarCommand implements Command {
    /**
     ...
     */
    @Resource
    @Qualifier("SincronizadorFuar")
    public Sincronizador sincronizadorFuar;

    /**
     * TODO [Constructor]
     * @author Orlando Adrián Ramos Galván,(orlandoa.ramos@outlook.com)
     */
    public SincFuarCommand() {
    ...
    public Callable<?> execute() {
        // TODO [codificar el cuerpo del método]
        return (Callable<?>) sincronizadorFuar;
    }
