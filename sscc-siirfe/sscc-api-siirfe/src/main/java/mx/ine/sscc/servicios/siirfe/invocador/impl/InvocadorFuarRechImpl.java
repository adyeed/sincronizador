...
import mx.ine.sscc.servicios.siirfe.command.impl.SincFuarRechCommand;
 ...
 * @since SIIRFE 5.10
 */
@Service("InvocadorFuarRechImpl")
public class InvocadorFuarRechImpl implements Invocador {
     ...
     * TODO [Constructor]
     * @author Orlando Adrián Ramos Galván,(orlandoa.ramos@outlook.com)
     * @param initSincFuarRechCommand
     */
    @Autowired
    public InvocadorFuarRechImpl(SincFuarRechCommand initSincFuarRechCommand) {
        // TODO [codificar el cuerpo del método]
        this.initSincCommand = initSincFuarRechCommand;
    }
