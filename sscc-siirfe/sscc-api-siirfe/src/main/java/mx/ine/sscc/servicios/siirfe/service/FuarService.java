...
public interface FuarService {
     ...
     */
    List<FuarSiirfe> obtieneListaFuar(Long bitacoraId);
     ...
     * @param bitacoraId
     */
    void actualizaFuar(Long id, String nuevoEstatus, Long bitacoraId);
     ...
     * @param boqueId
     */
    void actualizaBloqueFuar(String nuevoEstatus, Long bitacoraId);
