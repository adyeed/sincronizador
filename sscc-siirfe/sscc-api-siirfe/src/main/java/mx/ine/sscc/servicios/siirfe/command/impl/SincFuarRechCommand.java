 ...
 */
@Component
public class SincFuarRechCommand implements Command {
    /**
     ...
     */
    @Resource
    @Qualifier("SincronizadorFuarRech")
    public Sincronizador sincronizadorFuarRech;

    /**
     * TODO [Constructor]
     * @author Orlando Adrián Ramos Galván,(orlandoa.ramos@outlook.com)
     */
    public SincFuarRechCommand() {
    ...
    public Callable<?> execute() {
        // TODO [codificar el cuerpo del método]
        return (Callable<?>) sincronizadorFuarRech;
    }
