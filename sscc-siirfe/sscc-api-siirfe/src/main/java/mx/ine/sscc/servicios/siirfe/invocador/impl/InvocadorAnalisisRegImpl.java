...
import mx.ine.sscc.servicios.siirfe.command.impl.SincAnalisisCommand;
 ...
 * @since SIIRFE 5.10
 */
@Service("InvocadorAnalisisRegImpl")
public class InvocadorAnalisisRegImpl implements Invocador {
     ...
     * @author Orlando Adrián Ramos Galván,(orlandoa.ramos@outlook.com)
     */
    public InvocadorAnalisisRegImpl() {
     ...
     * TODO [Constructor]
     * @author Orlando Adrián Ramos Galván,(orlandoa.ramos@outlook.com)
     * @param sincAnalisisCommand
     */
    @Autowired
    public InvocadorAnalisisRegImpl(SincAnalisisCommand sincAnalisisCommand) {
        // TODO [codificar el cuerpo del método]
        this.initSincCommand = sincAnalisisCommand;
    }
