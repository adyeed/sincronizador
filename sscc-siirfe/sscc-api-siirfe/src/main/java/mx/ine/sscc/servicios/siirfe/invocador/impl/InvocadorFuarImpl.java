...
import mx.ine.sscc.servicios.siirfe.command.impl.SincFuarCommand;
 ...
 * @since SIIRFE 5.10
 */
@Service("InvocadorFuarImpl")
public class InvocadorFuarImpl implements Invocador {
     ...
     * TODO [Constructor]
     * @author Orlando Adrián Ramos Galván,(orlandoa.ramos@outlook.com)
     * @param initSincFuarCommand
     */
    @Autowired
    public InvocadorFuarImpl(SincFuarCommand initSincFuarCommand) {
        // TODO [codificar el cuerpo del método]
        this.initSincCommand = initSincFuarCommand;
    }
