 ...
 */
@Component
public class FuarObservador implements Observer {

    private static final Logger logger = LoggerFactory.getLogger(FuarObservador.class);

    @Resource
    private ExecutorServicesManagment executorServicesManagment;
    private ExecutorService executorService;
    @Resource
    @Qualifier("InvocadorFuarImpl")
    private Invocador InvocadorFuar;
    ...
    public void update(Observable observable, Object arg1) {
        ...
        try {
             ...
             * Invocador.
             */
            executorService.submit(InvocadorFuar.initSinc());
        } catch (Exception e) {
