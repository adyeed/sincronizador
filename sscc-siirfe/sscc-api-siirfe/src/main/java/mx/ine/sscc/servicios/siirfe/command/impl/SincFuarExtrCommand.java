 ...
 */
@Component
public class SincFuarExtrCommand implements Command {
    /**
     ...
     */
    @Resource
    @Qualifier("SincronizadorFuarExtr")
    public Sincronizador sincronizadorFuarExtr;
    ...
    public Callable<?> execute() {
        // TODO [codificar el cuerpo del método]
        return (Callable<?>) sincronizadorFuarExtr;
