 ...
 */
@Component
public class FuarRechObservador implements Observer {

    private static final Logger logger = LoggerFactory.getLogger(FuarRechObservador.class);

    @Resource
    private ExecutorServicesManagment executorServicesManagment;
    private ExecutorService executorService;
    @Resource
    @Qualifier("InvocadorFuarRechImpl")
    private Invocador invocadorFuarRech;
    ...
    public void update(Observable observable, Object arg1) {
        ...
        try {
             ...
             * Invocador.
             */
            executorService.submit(invocadorFuarRech.initSinc());
        } catch (Exception e) {
