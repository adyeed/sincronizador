 ...
 * @since SIIRFE 5.10
 */
@Component("ReenvioInvocador")
public class ReenvioInvocador implements Invocador {
    @Resource
    @Qualifier("ReenvioCommand")
    Command reenvioCommand;
