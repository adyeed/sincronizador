...
package mx.ine.sscc.servicios.unicom.invocador;

import java.util.concurrent.Callable;

/**
 * TODO [Interface que define el comportamiento de la clase encargada de invocar las unidades
 * de trabajo para crear las notificaciones .]
...
public interface Invocador {
    ...
    /**
     * TODO [Método que inicia la construccion de la notificación]
     * @author Orlando Adrián Ramos Galván,(orlandoa.ramos@outlook.com)
