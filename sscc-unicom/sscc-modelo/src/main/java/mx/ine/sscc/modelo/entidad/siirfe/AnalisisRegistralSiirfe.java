 ...
 * @since SIIRFE 6.1
 */
public class AnalisisRegistralSiirfe implements Serializable {

    private static final long serialVersionUID = 6638681463213903833L;
    ...
    public String toString() {
        return "AnalisisRegistralSiirfe [solicitudMacId=" + solicitudMacId + ", ciudadanoId="
            ...
            + ", paisTramite=" + paisTramite + ", controlSincronizacion="
            + controlSincronizacion + ", fuar=" + fuar + ", procesoSincronizacionId="
