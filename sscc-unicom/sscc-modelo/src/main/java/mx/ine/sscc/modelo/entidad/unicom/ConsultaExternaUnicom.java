...
/**
 * clase que representa a la tabla CONSULTAEXTERNA en el esquema de CONSULTAEXTERNA de UNICOM
 * @author Esther Flores Rodriguez (esther.fr03@gmail.com)
 * @version 1.0
 * @since SIIRFE 6.1
 */
public class ConsultaExternaUnicom implements Serializable {

    private static final long serialVersionUID = -3148776469890853934L;
    ...
    public String toString() {
        return "ConsultaExternaUnicom [ciudadanoId=" + ciudadanoId + ", credencialId="
            ...
            + causaRoboExtravioId + ", procesoSincronizacionId=" + procesoSincronizacionId
            + "]";
    }
