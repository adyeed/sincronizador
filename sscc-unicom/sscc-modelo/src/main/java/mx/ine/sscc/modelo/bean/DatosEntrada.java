...
import mx.ine.sscc.modelo.entidad.TmpCredencialUnica;
...
public class DatosEntrada implements Serializable {
    ...
    private List<TmpCredencialUnica> tmpCredencialUnicas;
    ...
    /**
     * @return el atributo tmpCredencialUnicas
     */
    public List<TmpCredencialUnica> getTmpCredencialUnicas() {
        return tmpCredencialUnicas;
    }

    /**
     * @param tmpCredencialUnicas parametro tmpCredencialUnicas a actualizar
     */
    public void setTmpCredencialUnicas(List<TmpCredencialUnica> tmpCredencialUnicas) {
        this.tmpCredencialUnicas = tmpCredencialUnicas;
    }
